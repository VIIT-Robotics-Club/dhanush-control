...
#define FLYWL_U_DIR GPIO_NUM_7

#define FLYWL_L_PWM GPIO_NUM_17
#define FLYWL_L_DIR GPIO_NUM_15

#define ARM_LIMIT_U GPIO_NUM_5
#define ARM_LIMIT_L GPIO_NUM_6

#define ARM_MOTOR_PWM GPIO_NUM_8
#define ARM_MOTOR_DIR GPIO_NUM_3

#define FLYW_ANGLE_L GPIO_NUM_2
#define FLYW_ANGLE_R GPIO_NUM_1
#define G_FLYW_ANGLE_DIR GPIO_NUM_0     //trial value - pass nothing
#define FINGER_GPIO  GPIO_NUM_14
#define GRIPPER_GPIO  GPIO_NUM_21
...
#define INDEX_FLYW_U 0
#define INDEX_FLYW_L 1
#define INDEX_ARM 2
